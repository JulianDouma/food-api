...
final class Kernel extends BaseKernel
{
    ...
    protected function configureContainer(ContainerConfigurator $container): void
    {
        ...
        $container->import(\sprintf('%s/config/{packages}/%s/*.php', $this->getProjectDir(), $this->getEnvironment()));

        $container->import(\sprintf('%s/config/{services}/*.php', $this->getProjectDir()));
        $container->import(\sprintf('%s/config/{services}/%s/*.php', $this->getProjectDir(), $this->getEnvironment()));
    }
